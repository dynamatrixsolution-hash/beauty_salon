      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <div className="relative w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-r from-brand-pink-accent to-brand-rosegold text-brand-charcoal-dark font-serif text-lg font-bold shadow-sm">
              G
              <Sparkles className="absolute -top-1 -right-1 w-3.5 h-3.5 text-brand-gold animate-pulse-slow" />
            </div>
